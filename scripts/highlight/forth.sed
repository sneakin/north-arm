...
# words
s,\(^[:]\+\|def\S*\|struct:\S*\|field:\S*\|\S\+&gt[;]\)\s\+\(\S\+\),<span class="defining">\1</span> <span class="name">\2</span>,g
s:\(begin\|begin-frame\):<span class="delimiting">\1</span>:g
s:\(\w\+' \|literal\|u\?int[0-9]\+\|float[0-9]\+\|pointer\|offset[0-9]\+\):<span class="type">\1</span>:g
s:\(,\w\+\):<span class="comma word">\1</span>:g
s:\(^[;]\|[;]$\|end\S*\):<span class="end-defining">\1</span>:g
s:\(\(set-\)\?\(arg\([0-9]\|n\)\|local\([0-9]\|n\)\)\):<span class="local">\1</span>:g

...
echo -e "\e[35;1mBuilding build/thumb-linux-android/bin/interp.elf\e[0m"
cat src/bin/interp.4th | LC_ALL=en_US.ISO-8859-1 bash ./src/bash/forth.sh > build/thumb-linux-android/bin/interp.elf
chmod u+x build/thumb-linux-android/bin/interp.elf
echo -e "\e[35;1mBuilding build/thumb-linux-gnueabi/bin/interp.elf\e[0m"
cat src/bin/interp.4th | LC_ALL=en_US.ISO-8859-1 bash ./src/bash/forth.sh > build/thumb-linux-gnueabi/bin/interp.elf
chmod u+x build/thumb-linux-gnueabi/bin/interp.elf
...
mkdir -p build/thumb-linux-android/bin/
echo '" ./src/bin/builder.4th" load build' |  ./build/thumb-linux-static/bin/interp.elf -t thumb-linux-android -e main -o build/thumb-linux-android/bin/interp.1.elf src/include/interp.4th
...
mkdir -p build/thumb-linux-static/bin/
./build/thumb-linux-static/bin/builder+core.1.elf -t thumb-linux-static -e build -o build/thumb-linux-static/bin/builder.2.elf src/include/interp.4th src/interp/cross.4th src/bin/builder.4th
...
mkdir -p build/thumb-linux-android/bin/
./build/thumb-linux-static/bin/builder+core.3.elf -t thumb-linux-android -e  main -o build/thumb-linux-android/bin/interp+core.3.elf  src/include/interp.4th src/lib/structs.4th src/interp/cross.4th src/interp/boot/include.4th
...
mkdir -p build/thumb-linux-gnueabi/bin/
echo '" ./src/bin/builder.4th" load build' |  ./build/thumb-linux-static/bin/interp.elf -t thumb-linux-gnueabi -e main -o build/thumb-linux-gnueabi/bin/interp.1.elf src/include/interp.4th
...
mkdir -p build/thumb-linux-gnueabi/bin/
./build/thumb-linux-static/bin/builder+core.3.elf -t thumb-linux-gnueabi -e  main -o build/thumb-linux-gnueabi/bin/interp+core.3.elf  src/include/interp.4th src/lib/structs.4th src/interp/cross.4th src/interp/boot/include.4th
...
mkdir -p build/thumb-linux-static/bin/
echo '" ./src/bin/builder.4th" load build' |  ./build/thumb-linux-static/bin/interp.elf -t thumb-linux-static -e main -o build/thumb-linux-static/bin/interp.1.elf src/include/interp.4th
...
mkdir -p build/thumb-linux-static/bin/
./build/thumb-linux-static/bin/builder+core.3.elf -t thumb-linux-static -e  main -o build/thumb-linux-static/bin/interp+core.3.elf  src/include/interp.4th src/lib/structs.4th src/interp/cross.4th src/interp/boot/include.4th
...
mkdir -p build/thumb-linux-android/bin/
./build/thumb-linux-static/bin/builder+core.1.elf -t thumb-linux-android -e build -o build/thumb-linux-android/bin/builder.2.elf src/include/interp.4th src/interp/cross.4th src/bin/builder.4th
echo -e "\e[36;1mBuilding build/thumb-linux-android/bin/interp.2.elf\e[0m"
mkdir -p build/thumb-linux-android/bin/
./build/thumb-linux-static/bin/builder+core.1.elf -t thumb-linux-android -e main -o build/thumb-linux-android/bin/interp.2.elf src/include/interp.4th
echo -e "\e[36;1mBuilding build/thumb-linux-android/bin/runner.2.elf\e[0m"
mkdir -p build/thumb-linux-android/bin/
./build/thumb-linux-static/bin/builder+core.1.elf -t thumb-linux-android -e runner-boot -o build/thumb-linux-android/bin/runner.2.elf src/interp/strings.4th src/runner/main.4th
echo -e "\e[36;1mBuilding build/thumb-linux-gnueabi/bin/builder.2.elf\e[0m"
mkdir -p build/thumb-linux-gnueabi/bin/
./build/thumb-linux-static/bin/builder+core.1.elf -t thumb-linux-gnueabi -e build -o build/thumb-linux-gnueabi/bin/builder.2.elf src/include/interp.4th src/interp/cross.4th src/bin/builder.4th
echo -e "\e[36;1mBuilding build/thumb-linux-gnueabi/bin/interp.2.elf\e[0m"
mkdir -p build/thumb-linux-gnueabi/bin/
./build/thumb-linux-static/bin/builder+core.1.elf -t thumb-linux-gnueabi -e main -o build/thumb-linux-gnueabi/bin/interp.2.elf src/include/interp.4th
echo -e "\e[36;1mBuilding build/thumb-linux-gnueabi/bin/runner.2.elf\e[0m"
mkdir -p build/thumb-linux-gnueabi/bin/
./build/thumb-linux-static/bin/builder+core.1.elf -t thumb-linux-gnueabi -e runner-boot -o build/thumb-linux-gnueabi/bin/runner.2.elf src/interp/strings.4th src/runner/main.4th
echo -e "\e[36;1mBuilding build/thumb-linux-static/bin/interp.2.elf\e[0m"
mkdir -p build/thumb-linux-static/bin/
./build/thumb-linux-static/bin/builder+core.1.elf -t thumb-linux-static -e main -o build/thumb-linux-static/bin/interp.2.elf src/include/interp.4th
echo -e "\e[36;1mBuilding build/thumb-linux-static/bin/runner.2.elf\e[0m"
mkdir -p build/thumb-linux-static/bin/
./build/thumb-linux-static/bin/builder+core.1.elf -t thumb-linux-static -e runner-boot -o build/thumb-linux-static/bin/runner.2.elf src/interp/strings.4th src/runner/main.4th
...
mkdir -p build/thumb-linux-android/bin/
./build/thumb-linux-static/bin/builder+core.2.elf -t thumb-linux-android -e main -o build/thumb-linux-android/bin/interp.3.elf src/include/interp.4th
...
mkdir -p build/thumb-linux-gnueabi/bin/
./build/thumb-linux-static/bin/builder+core.2.elf -t thumb-linux-gnueabi -e main -o build/thumb-linux-gnueabi/bin/interp.3.elf src/include/interp.4th
...
mkdir -p build/thumb-linux-static/bin/
./build/thumb-linux-static/bin/builder+core.2.elf -t thumb-linux-static -e main -o build/thumb-linux-static/bin/interp.3.elf src/include/interp.4th
...
mkdir -p build/thumb-linux-android/bin/
./build/thumb-linux-static/bin/builder+core.3.elf -t thumb-linux-android -e main -o build/thumb-linux-android/bin/interp.4.elf src/include/interp.4th
...
mkdir -p build/thumb-linux-gnueabi/bin/
./build/thumb-linux-static/bin/builder+core.3.elf -t thumb-linux-gnueabi -e main -o build/thumb-linux-gnueabi/bin/interp.4.elf src/include/interp.4th
...
mkdir -p build/thumb-linux-static/bin/
./build/thumb-linux-static/bin/builder+core.3.elf -t thumb-linux-static -e main -o build/thumb-linux-static/bin/interp.4.elf src/include/interp.4th

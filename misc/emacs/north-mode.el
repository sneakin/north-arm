...
(setf north-syntax--defining-words (list ":" "def" "defcol" "defop" "var>" "const>" "defvar>" "defconst>" "alias>" "defalias>" "symbol>" "mark>" "push-mark>" "sys::" "sys:def" "sys:defcol" "sys-def" "sys-defcol"))
...
(defun north-smie--indentation-rules (kind token)
  (pcase (cons kind token)
    (`(:elem . args)
     (cond ((smie-rule-prev-p ":" "def" "defcol" "defop" "s\\[" "sys::" "sys:def" "sys:defcol" "sys-def" "sys-defcol")
            (- (+ (save-excursion
    ...
    (`(:after . "sys:def") (* 2 forth-smie-basic-indent))
    (`(:list-intro . "sys:def") nil)
    (`(:after . "sys:defcol") (* 2 forth-smie-basic-indent))
    (`(:list-intro . "sys:defcol") nil)
    (`(:after . "sys-def") (* 2 forth-smie-basic-indent))
    (`(:list-intro . "sys-def") nil)
    (`(:after . "sys-defcol") (* 2 forth-smie-basic-indent))
    (`(:list-intro . "sys-defcol") nil)
    (`(:after . "sys::") (* 2 forth-smie-basic-indent))
    (`(:list-intro . "sys::") nil)

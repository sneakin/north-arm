...
def test-epoll
  ...
  local1 0 EpollEvent struct-seq-nth EpollEvent . data @ 54321 assert-equals
  ( write to the pipe )
  ...
  local1 1 EpollEvent struct-seq-nth EpollEvent . data @ 12345 assert-equals

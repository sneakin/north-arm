...
DICT['swap-overn']='tmp="${STACK[$((1 + ${STACK[0]}))]}"; STACK[$((1 + ${STACK[0]}))]="${STACK[1]}"; fpop 2; fpush "${tmp}"'
DICT['swap']='STACK=("${STACK[1]}" "${STACK[0]}" "${STACK[@]:2}")'
DICT['roll']='STACK=("${STACK[2]}" "${STACK[0]}" "${STACK[1]}" "${STACK[@]:3}")'
DICT['shift']='STACK=("${STACK[1]}" "${STACK[2]}" "${STACK[0]}" "${STACK[@]:3}")'
